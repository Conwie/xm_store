...
"/image/pinpai1.png", 1, 10, "超级管理员", now(), "超级管理员", now()),
(100002, 2, "电视", "小米电视3s 55英寸", "5月9日，下单立减200元", 3999, 9999, 
"/image/pinpai4.png", 1, 8, "超级管理员", now(), "超级管理员", now()),
(100003, 1, "手机", "小米5s", "5月9日-10日，下单立减200元", 1999, 9999, 
"/image/pinpai2.png", 1, 8, "超级管理员", now(), "超级管理员", now()),
(100004, 3, "电脑", "小米笔记本", "更轻更薄，像杂志一样随身携带", 3599, 9999, 
"/image/pinpai3.png", 1, 9, "超级管理员", now(), "超级管理员", now()),
(100005, 1, "小米手机", "小米手机5 64GB", "5月9日-10日，下单立减100元", 1799, 9999, 
"/image/pinpai5.png", 1, 10, "超级管理员", now(), "超级管理员", now());
